...
<title>@yield('title','Admin') — WesterosGate</title>
...
<aside class="adm-sidebar" id="sidebar">
  ...
  <nav class="adm-nav">
    ...
    <a href="{{ route('admin.articles.index') }}" class="adm-nav-item {{ request()->routeIs('admin.articles.index') ? 'active' : '' }}">
    ...
    <a href="{{ route('admin.articles.create') }}" class="adm-nav-item {{ request()->routeIs('admin.articles.create') ? 'active' : '' }}">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
      <span class="sidebar-text">Artikel Baru</span>
    </a>
    <a href="{{ route('admin.password.edit') }}" class="adm-nav-item {{ request()->routeIs('admin.password.edit') ? 'active' : '' }}">
  ...
  <div class="adm-user-badge">
    <div class="adm-avatar">{{ substr(Auth::guard('admin')->user()->name, 0, 1) }}</div>
    <div style="min-width:0" class="adm-user-info">
      <div class="adm-uname">{{ Auth::guard('admin')->user()->name }}</div>
      <div class="adm-uemail">{{ Auth::guard('admin')->user()->email }}</div>
    </div>
  </div>
</aside>
...
<div class="adm-main" id="adm-main">
  <header class="adm-topbar">
    ...
    <span class="adm-topbar-date">{{ now()->translatedFormat('d F Y') }}</span>
  </header>
  ...
  <div class="adm-content">@yield('content')</div>
</div>
