...
<div class="stat-cards">
  <div class="stat-card stat-total">
    ...
    <div><div class="stat-number"><?php echo e($totalArticles); ?></div><div class="stat-label">Total Artikel</div></div>
  </div>
  <div class="stat-card stat-published">
    ...
    <div><div class="stat-number"><?php echo e($published); ?></div><div class="stat-label">Dipublikasikan</div></div>
  </div>
  <div class="stat-card stat-draft">
    ...
    <div><div class="stat-number"><?php echo e($draft); ?></div><div class="stat-label">Draft</div></div>
  </div>
  <div class="stat-card stat-cat">
    ...
    <div><div class="stat-number"><?php echo e($categories->count()); ?></div><div class="stat-label">Kategori</div></div>
  </div>
</div>
...
<div class="dash-grid">
  <div class="dash-block">
    <div class="dash-block-header">
      ...
      <a href="<?php echo e(route('admin.articles.index')); ?>" class="btn-sm">Lihat Semua</a>
    </div>
    <table class="adm-table">
      <thead><tr><th>Judul</th><th>Kategori</th><th>Status</th><th>Tanggal</th><th>Aksi</th></tr></thead>
      <tbody>
        <?php $__currentLoopData = $recentArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          <td><div class="table-title"><?php echo e(Str::limit($a->title,52)); ?></div></td>
  ...
  <div class="dash-block">
    ...
    <div class="quick-actions">
      <a href="<?php echo e(route('admin.articles.create')); ?>" class="quick-btn">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
        Tulis Artikel Baru
      </a>
      <a href="<?php echo e(route('admin.articles.index')); ?>" class="quick-btn">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
        Semua Artikel
      </a>
      <a href="<?php echo e(route('home')); ?>" target="_blank" class="quick-btn">
    ...
    <div class="cat-dist">
      ...
      <div class="cat-dist-item">
        <div class="cat-dist-label"><span><?php echo e(Str::limit($c->category,26)); ?></span><span><?php echo e($c->total); ?></span></div>
        <div class="cat-dist-bar"><div class="cat-dist-fill" style="width:<?php echo e(($c->total/$mx)*100); ?>%"></div></div>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
  </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kipe\Documents\perkuliahan\Semester 4\PBW\westerosgate\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>