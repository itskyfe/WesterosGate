    ...
    <div class="form-card">
      ...
      <div class="form-card-body">
        <div class="image-upload-area" onclick="document.getElementById('imgIn').click()">
          <div class="image-placeholder" id="imgPh" style="<?php echo e($article->image ? 'display:none' : ''); ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
            <p>Klik untuk upload</p>
            <small>JPG, PNG — maks. 2MB</small>
          </div>
          <img id="imgPrev" src="<?php echo e($article->image ? $article->image_url : ''); ?>" alt="" style="<?php echo e($article->image ? 'display:block;' : 'display:none;'); ?>width:100%;border-radius:5px">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kipe\Documents\perkuliahan\Semester 4\PBW\westerosgate\resources\views/admin/articles/edit.blade.php ENDPATH**/ ?>